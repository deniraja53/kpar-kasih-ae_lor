...
const App = () => {
        ...
        <div className="flex flex-col items-center justify-center h-full text-center p-8">
          ...
          >
            ...
            <ul className="space-y-3">
              {[
                "Memahami arti kasih (1 Korintus 13)",
                "Mengidentifikasi bentuk kasih sehari-hari",
                "Berkomitmen mempraktikkan kasih",
              ].map((item, i) => (
        ...
        <div className="p-8 h-full flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-8 items-center h-full">
            <div className="flex flex-col gap-6">
              <div
                className="glass-card p-6"
                style={{ borderLeft: "8px solid var(--primary)" }}
              >
              ...
              <p style={{ lineHeight: "1.8", fontSize: "1.1rem" }}>
                Halo anak-anak hebat! Kasih bukan cuma perasaan di hati saja,
                lho. Dalam Alkitab, ada tindakan{" "}
                <span
                  className="font-bold"
              ...
              <div className="flex flex-col gap-4">
                <div className="glass-card p-4 flex items-center gap-4">
                  ...
                  <span>
                    Kasih adalah <span className="font-bold">Kata Kerja</span>{" "}
                    (tindakan nyata)
                  </span>
                </div>
                <div className="glass-card p-4 flex items-center gap-4">
            ...
            <div className="flex flex-col gap-4 h-full">
              <div
                className="glass-card flex-1 flex items-center justify-center p-2"
                style={{
        ...
        <div className="p-8 h-full">
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              {
                title: "Kepada Tuhan",
                desc: "Berdoa, ibadah, dan taat firman-Nya.",
                icon: <Sun size={40} color="var(--accent)" />,
              },
              {
                title: "Diri Sendiri",
                desc: "Menjaga tubuh (Bait Allah) & bersyukur.",
                icon: <Heart size={40} color="var(--primary)" />,
              },
              {
                title: "Kepada Sesama",
                desc: "Keluarga, teman, guru, bahkan musuh!",
              ...
              >
                <div
                  className="mb-6 p-4 pointer-events-none"
                  style={{
                    background: "rgba(255,255,255,0.05)",
                    borderRadius: "20px",
                  }}
                ...
                <h3 className="text-xl font-bold mb-3 pointer-events-none">
                  {item.title}
                </h3>
                <p
      ...
      content: (
        <div className="p-8 h-full flex flex-col items-center">
          <h2 className="text-3xl font-bold mb-4 flex items-center gap-3">
            <Heart color="var(--primary)" fill="var(--primary)" /> Klik 5 Ikon
            Love Untuk Temukan Kasih!
          </h2>
          <p className="mb-12 opacity-80 italic text-lg text-center">
            Setiap ikon menyimpan rahasia bagaimana kamu bisa menemukan kasih
            hari ini...
          </p>
              ...
              <div key={qIdx} className="glass-card p-6">
                ...
                {quizFeedback[qIdx] && (
                  <p
                    ...
                    style={{ color: quizScores[qIdx] ? "#00ff80" : "#ff2a6d" }}
                  >
                    {quizScores[qIdx] ? (
        ...
        <div className="p-8 h-full flex flex-col items-center justify-center">
          ...
          <div className="w-full max-w-2xl glass-card p-8 relative">
            ...
            <p className="mb-6 font-medium text-lg">
              Tuhan Yesus ingin kamu menjadi saluran kasih. Apa{" "}
          ...
          {isReflectionSaved && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="mt-8 font-bold text-center text-xl"
      ...
      content: (
        <div className="p-8 h-full flex flex-col overflow-y-auto">
          ...
          <div className="mt-auto text-center pb-4">
            <p
              className="text-2xl font-bold drop-shadow-lg mb-2"
              style={{ color: "var(--primary)" }}
            >
  ...
  const Navigation = ({ className = "" }) => (
    <div
      className={`flex justify-between items-center bg-black/10 backdrop-blur-md ${className || "p-6"}`}
    >
      <button
        onClick={prevSlide}
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-[#0a050a] p-2 md:p-4 overflow-auto">
        <div
          className="relative flex flex-col p-0 overflow-hidden shadow-2xl slide-content"
          style={{
            width: "100%",
            maxWidth: "1024px",
            height: "auto",
        ...
        >
          ...
          <div
            className="slide-content glass-card relative w-full h-full flex flex-col p-0 overflow-hidden"
            style={{ borderRadius: "0px" }}
          >
            {/* Slide Window */}
            <div
              className={`flex-1 overflow-hidden relative ${currentSlide === 4 ? "p-0" : "p-4"}`}
            >
            ...
            {/* Navigation Wrapper */}
            {currentSlide !== 4 && (
              <Navigation className="border-t border-white/10" />
            )}
          </div>
        </div>
      </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
              {showPopup === 1 && (
                <div className="space-y-6 text-center">
                  <div className="grid grid-cols-2 gap-4">
                    <img
                      src="/images/bukti-kasih-tuhan-1.jpg"
                      alt="Proof 1"
                      className="w-full h-auto rounded-2xl border-2 border-white/10"
                    />
                    <img
                      src="/images/bukti-kasih-tuhan-2.jpg"
                      alt="Proof 2"
                      className="w-full h-auto rounded-2xl border-2 border-white/10"
                    />
                  </div>
                  <div className="p-4 glass-card bg-white/5 border-none">
                    <p className="text-lg italic opacity-90">
                      "Kasih kepada Tuhan diwujudkan melalui ketaatan dan ibadah
                      yang tulus."
                    </p>
                  </div>
                </div>
              ...
              {showPopup === 2 && (
                <div className="space-y-6 text-center">
                  <div className="grid grid-cols-2 gap-4">
                    <img
                      src="/images/kasih-diri-sendiri-1.jpg"
                      alt="Hati yang Bersyukur"
                      className="w-full h-auto rounded-2xl border-2 border-white/10"
                    />
                    <img
                      src="/images/kasih-diri-sendiri-2.jpg"
                      alt="Tubuh sebagai Bait Allah"
                      className="w-full h-auto rounded-2xl border-2 border-white/10"
                    />
                  </div>
                  <div className="p-4 glass-card bg-white/5 border-none">
                    <p className="text-lg italic opacity-90">
                      "Mengasihi diri sendiri berarti menjaga tubuh sebagai Bait
                      Allah dan selalu memiliki hati yang bersyukur."
                    </p>
                  </div>
                </div>
              )}
              {showPopup === 3 && (
                <div className="space-y-6 text-center">
                  <div className="grid grid-cols-2 gap-4">
                    <img
                      src="/images/kasih-sesama-1.jpg"
                      alt="Kasih Sesama 1"
                      className="w-full h-auto rounded-2xl border-2 border-white/10"
                    />
                    <img
                      src="/images/kasih-sesama-2.jpg"
                      alt="Kasih Sesama 2"
                      className="w-full h-auto rounded-2xl border-2 border-white/10"
                    />
                  </div>
                  <div className="p-4 glass-card bg-white/5 border-none">
                    <p className="text-lg italic opacity-90">
                      "Mengasihi sesama berarti peduli, berbagi, dan menolong
                      siapa saja yang membutuhkan dengan hati yang tulus."
                    </p>
                  </div>
                </div>
              )}
              {showPopup >= 4 && showPopup <= 8 && (
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-8 p-10">
                  ...
                  <p className="text-3xl font-bold leading-relaxed text-white">
                    {showPopup === 4 &&
                      "Di Rumah: Bagaimana kamu menunjukkan kasih kepada orang tuamu hari ini?"}
                    {showPopup === 5 &&
                      "Di Sekolah: Apa yang bisa kamu lakukan jika melihat teman yang sedang sedih?"}
                    {showPopup === 6 &&
                      "Saat Bermain: Bagaimana sikap kasih saat kamu kalah dalam permainan?"}
                    {showPopup === 7 &&
                      "Terhadap Guru: Mengapa kita harus menghormati dan mendengarkan nasihat guru?"}
                    {showPopup === 8 &&
                      "Untuk Diri Sendiri: Mengapa bersyukur setiap pagi adalah bentuk kasih pada diri sendiri?"}
                  </p>
                  <div className="p-6 glass-card border-none bg-white/5 max-w-2xl w-full">
                    <p className="text-xl italic text-accent">
                      {showPopup === 4 &&
                        "Kasih dimulai dari hal kecil di rumah, seperti membantu atau mendengarkan nasihat."}
                      {showPopup === 5 &&
                        "Menghibur teman adalah wujud nyata kasih AGAPE yang tidak mementingkan diri sendiri."}
                      {showPopup === 6 &&
                        "Tetap rendah hati dan menghargai teman adalah tanda hati yang penuh kasih."}
                      {showPopup === 7 &&
                        "Guru adalah wakil Tuhan di sekolah yang membimbing kita menjadi anak yang bijak."}
                      {showPopup === 8 &&
                        "Mencintai dirimu sendiri berarti menghargai ciptaan Tuhan yang paling berharga: Kamu!"}
                    </p>
                  </div>
                </div>
              )}
