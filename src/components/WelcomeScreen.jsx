      ...
      {!clicked && (
        <motion.div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, #0f0218 0%, #1e0435 40%, #0f0218 100%)",
            overflow: "hidden",
          }}
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(255,42,109,0.18) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(255,101,189,0.12) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            ...
            <motion.h1
              ...
              style={{
                ...
                margin: "0 0 8px",
                background:
                  "linear-gradient(135deg, #ff2a6d, #ff65bd, #ffb3d9)",
            ...
            >
              ...
              <motion.svg
                ...
                style={{
                  ...
                  height: 180,
                  filter:
                    "drop-shadow(0 0 30px rgba(255,42,109,0.7)) drop-shadow(0 0 60px rgba(255,42,109,0.35))",
                }}
              >
                <defs>
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: 2,
              background:
                "linear-gradient(90deg, transparent, rgba(255,42,109,0.6), transparent)",
            }}
          />
        </motion.div>
      )}
